...
do
	...
	do
		echo "Iteration $i"
		./threaded_https_client -b 1024 -c 1 -d 1000000 -f refactor_04.csv -h 192.168.21.101 -t $i 
		#sleep 5
	done
	...
	do
		echo "Iteration $i"
		./threaded_https_client -b 1024 -c 1 -d 1000000 -f refactor_04.csv -h 192.168.21.101 -t $i -s
		#sleep 5
	done
done
