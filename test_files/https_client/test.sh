...
do
	...
	do
		echo "Iteration $i"
		./threaded_https_client -b 1024 -c 1 -d 1000000 -f refactor_07.csv -h www.phoenixteam.net -t $i 
		#sleep 5
	done
	...
	do
		echo "Iteration $i"
		./threaded_https_client -b 1024 -c 1 -d 1000000 -f refactor_07.csv -h www.phoenixteam.net -t $i -s
		#sleep 5
	done
done
