...
#define NOTIFICATION_TEXT_1	"To use Securely, open the app and connect to "
#define NOTIFICATION_TEXT_2	"To use Securely, open the app and connect to your computer"
